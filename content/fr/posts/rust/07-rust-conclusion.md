...
J'ai beaucoup aimé découvrir Rust, je comprends maintenant la poularité du langage.
...
language est relativement jeune par rapport à d'autres et qu'il a beaucoup
appris de décénnies de développement informatique.
...
language vient avec ses choix, ses forces mais aussi ses inconvénients :

- le code peut être relativement verbeux : le fait de toujours devoir vérifier
que l'opération que l'on faire faire soit valide induit un long plus long que
dans d'autres langages.
- le temps de compilation est souvent pointé du doigts : en effet, toutes les
...
les résultats sont impressionants : moins de bugs et des améliorations de performance
jusqu'à 25 % ! Cependant, quelques mois plus tard, des miliers de sites ont été
...
Si vous aussi, vous voulez donner une chance à ce langage, voila une petite liste
...
que j'ai trouvé très complémentaire au tutoriel officel, très facile à lire
- les replays des conférences le la [Rust Nation UK](https://www.youtube.com/@rustnationuk/videos)
- le livre [Rust for Rustaceans](Rust for Rustaceans), pour un public plus intermédiaire,
il faudra notamment que je relise la seconde moitié du livre quand j'aurai plus
d'expériences
...
Oui clairement, la question étant plus de savoir commment car il ne m'est pas utile
au travail. Une de mes passions est également le développement de jeux vidéos mais
je comptais plus donner une chance à [Godot](https://godotengine.org/)
qu'à [Bevy](https://bevy.org/) prochainement ..
J'ai dévéloppé une api avec [Axum](https://github.com/tokio-rs/axum) que je vais
maintenir, et j'avoue que le crate [Ratatui](https://ratatui.rs/) me donne bien
envie pour découvrir le mondes des applications qui s'affichent dans le
