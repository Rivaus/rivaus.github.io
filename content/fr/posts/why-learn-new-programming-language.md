...
livres techniques, je me suis motivé pour commencer [The Pragmatic Programmer](https://pragprog.com/titles/tpp20/the-pragmatic-programmer-20th-anniversary-edition/)
et suis tombé sur ces lignes :
...
help broaden your thinking and avoid getter stuck in a rut. [...]

En école d'ingénieur, j'avais fait essentiellement du C (j'ai tout oublié),
beaucoup de Java, du C++ et du C#. C'est avec ce dernier que je développe exclusivement
depuis 5 ans puisque je travaille au quotidien avec le moteur de jeu [Unity](https://unity.com).
Ces mots m'ont donc remotivé à apprendre un nouveau langage, pour voir autre chose.

J'ai essayé de reprendre C++ avec l'excellent site [learn cpp](https://www.learncpp.com/)
en décembre 2024 mais plusieurs éléments m'ont fait lâcher au bout de quelque temps
(manque de motivation, manque de projets à faire avec, etc) alors que j'avais
...
différentes de celles des "langages dérivés du C" comme C++, C#, Java,...
...
se différencier sur plusieurs aspects :
...
Python. Pour ne pas rendre ce article indigeste, je vais consacrer une série
